...
function Game() {
    ...
    const fetchWord = () => {
        axios
            .get("https://wordleserver-antoines-projects-bf7851c2.vercel.app/api/word")
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post("https://wordleserver-antoines-projects-bf7851c2.vercel.app/api/guess", { guess, word })
            .then((response) => {
